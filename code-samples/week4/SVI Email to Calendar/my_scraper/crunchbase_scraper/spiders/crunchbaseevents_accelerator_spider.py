...
class CrunchBaseEventsSpider(BaseSpider):
    """Spider for the CrunchBase Accelerator Deadline Newsletter"""
    ...
    events_list_xpath = '/html/body/center/table[12]/tbody/tr/td/table/tbody/tr/td/table/tbody/tr/td[not(@align)]'    
    ...
    item_fields = {    
                   'description':   './table/tbody/tr/td[2]/table/tbody/tr[3]/td/text()',
                   'summary':       './table/tbody/tr/td[2]/table/tbody/tr[1]/td/a/text()',
                   'link':          './table/tbody/tr/td[2]/table/tbody/tr[1]/td/a/@href',
                   'end':           './table/tbody/tr/td[2]/table/tbody/tr[2]/td/text()',
                   }
