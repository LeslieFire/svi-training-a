...
Input: None
Output: This is the spider that crawls the specified website or local files
based on the given xpaths then returns those values.

To Do: create another spider that could get more details from the crunchbase
Email.
'''
...
class CrunchBaseEventsSpider(BaseSpider):
    ...
    #change this to path to point to your local's saved static html files.
