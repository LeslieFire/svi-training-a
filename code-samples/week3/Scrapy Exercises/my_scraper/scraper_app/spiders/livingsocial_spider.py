...
class LivingSocialSpider(BaseSpider):
    ...
    #element li with dealid parameter, element span with itemscope parameter, element meta with itemprop parameter with value "name",  return the value of parameter content.
